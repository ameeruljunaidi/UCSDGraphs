...
public class GraphLoader {
     ...
     * <p>
     * The file contains data lines as follows: lat1 lon1 lat2 lon2 roadName roadType where each line is a segment of a
     * road These road segments are assumed to be ONE WAY.
     * <p>
    ...
    public static void loadRoadMap(String filename, roadgraph.MapGraph map,
        ...
        // The nodes and the pointMap object are only created her to be passed on to the addEdgesAndSegments method
        ...
        for (GeographicPoint pt : intersections) {
            map.addVertex(pt);
            if (intersectionsToLoad != null) intersectionsToLoad.add(pt);
            nodes.add(pt);
        }
    ...
    private static void addEdgesAndSegments(Collection<GeographicPoint> nodes,
                                            ...
                                            MapGraph map, HashMap<GeographicPoint, HashSet<RoadSegment>> segments) {
    ...
    // Find all the intersections.  Intersections are either dead ends (1 road in and 1 road out, which are the reverse
    // of each other) or intersections between two different roads, or where three or more segments of the same road
    // meet.
     ...
     * The map returned is indexed by a GeographicPoint.  The values are lists of length two where each entry in the
     * list is a list. The first list stores the outgoing roads while the second stores the outgoing roads.
     *
     * @param filename the name the file
     * @return the map from points to lists of lists of lines
     */
    ...
    public static void main(String[] args) {
        // GraphLoader.createIntersectionsFile("data/maps/hollywood_small.map", "data/intersections/hollywood_small
        // .intersections");
        ...
        // GraphLoader.createIntersectionsFile("data/maps/stjoseph.map", "data/intersections/stjoseph.intersections");
    }
